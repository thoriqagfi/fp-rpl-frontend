...
const DropDownSidebar = ({ name }: DropDownSidebarProps) => {
  return (
    <li>
      <Link
        href="#"
...
type ListUserProfileProps = {
  href: string;
  name: string;
};
const ListUserProfile = ({ href, name }: ListUserProfileProps) => {
  return (
    <li>
      <Link
        href={href}
              ...
              <div className="flex items-center ml-3">
                ...
                >
                  ...
                  <ul className="py-1" role="none">
                    <ListUserProfile href="#" name="Dashboard" />
                    <ListUserProfile href="#" name="Settings" />
                    <ListUserProfile href="#" name="Earnings" />
                    <ListUserProfile href="#" name="Sign Out" />
                  </ul>
                </div>
              </div>
            </div>
