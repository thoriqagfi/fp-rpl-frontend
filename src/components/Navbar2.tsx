...
<nav className="bg-white px-2 sm:px-4 py-1.5 fixed w-full z-20 top-0 left-0 border-b border-gray-200">
  <div className="container flex flex-wrap items-center justify-between mx-auto">
      ...
      <div className="flex md:order-2">
        <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none lg:px-5 focus:ring-blue-300 font-medium rounded-lg text-sm py-1.5 px-2.5 text-center inline-flex items-center mr-4 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 sm:px-3">
          <svg aria-hidden="true" className="w-5 h-5 lg:mr-2 sm:ml-0 sm:mr-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 3H6.28l-.31-1.243A1 1 0 005 1H3zM16 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"></path></svg>
      ...
      <div className="items-center justify-center hidden w-full mr-32 md:flex md:w-auto md:order-1" id="navbar-sticky">
        <ul className="flex flex-col p-4 mt-4 border mr-10 border-gray-100 rounded-lg mx-auto bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white">
          <li>
