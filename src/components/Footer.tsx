...
const Footer = () => {
    ...
    <footer className="bg-gray-200 shadow-lg">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul className="text-gray-600">
                        ...
                        <li>
                            <a href="#" className="hover:underline">All Product</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul className="text-gray-600">
                        ...
                        <li>
                            <a href="#" className="hover:underline">Mail Us</a>
                        </li>
                    </ul>
                </div>
                <div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center">© 2023 <a href="#" className="hover:underline">Ecommerce</a>. All Rights Reserved.
            </span>
